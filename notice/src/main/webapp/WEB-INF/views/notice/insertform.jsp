...
<div class="container">
	...
	<form action="insert.do" method="post">
		<div class="form-group">
			...
			<input class="form-control" type="text" value="${id }" disabled/> <!-- 보여주기 용도  -->
		</div>
		<div class="form-group">
...
<%--
	...
	2. WebContent 에 upload 폴더 만들어 두기 => .gitignore 파일 추가
	3. WebContent/WeB-INF/lib 폴더에
	   commons-io.jar 파일과 commons-fileupload.jar 파일 붙여 넣기
	4. <textarea id="content" name="contetn">
	   content 가 아래의 javascript 에서 사용 되기 때문에 다른 이름으로 바꾸고
